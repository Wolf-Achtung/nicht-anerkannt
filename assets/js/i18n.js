...
(function () {
  ...
  var BUILTIN = {
    ...
    'daily.thenAI':             { de: 'Erst du. Danach widerspricht die KI.', en: 'You first. Then the AI pushes back.' },
    'daily.konterLoading':      { de: 'Die KI liest deine Antwort…', en: 'The AI is reading your answer…' },
    'daily.kiKontert':          { de: 'Die KI widerspricht',   en: 'The AI pushes back' },
    'daily.kiKontert2':         { de: 'Die KI bleibt dran',    en: 'The AI stays on it' },
    'daily.widerspruch':        { de: 'Widerspruch',           en: 'Objection' },
    'daily.blindeStelle':       { de: 'Blinde Stelle',         en: 'Blind spot' },
    'daily.gegenfrage':         { de: 'Gegenfrage',            en: 'Counter-question' },
    'daily.round2Label':        { de: 'Runde 2: Antworte noch einmal — schärfer.', en: 'Round 2: Answer again — sharper.' },
    'daily.round2Placeholder':  { de: 'Deine geschärfte Antwort…', en: 'Your sharpened answer…' },
    'daily.round2Btn':          { de: 'Nachschärfen',          en: 'Sharpen' },
    ...
    'nav.salon':           { de: 'Mitdiskutieren',         en: 'Join the Debate' },
    'nav.ideenArchiv':     { de: 'Ideen-Archiv',           en: 'Ideas Archive' },
    'nav.werkstatt':       { de: 'Ausprobieren',           en: 'Try It' },
    'nav.kiUndLernen':     { de: 'KI & Lernen',            en: 'AI & Learning' },
